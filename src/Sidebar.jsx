...
export default function Sidebar({data,raw,page,onNavigate,collapsed,onToggle,avatar}) {
 ...
 return <aside className={`sidebar file-sidebar ${collapsed?'is-collapsed':''}`} aria-label="Workspace sidebar">
  <div className="brand"><img className="site-logo" src={data.theme==='light'?'/Black_Logo.png':'/White_Logo.png'} alt="KARIBOK"/><div className="brand-copy"><strong>KARIBOK</strong><div className="brand-sub">study • work • hustle</div></div></div>
