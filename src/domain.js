...
export function normalize(raw) {
 const v={name:'Student',photo:'',theme:'system',accent:'#8b3f2f',timeZone:'',tasks:[],categories:['School','Work','Freelance','Personal'],projects:[],clients:[],payments:[],accounts:[],transactions:[],utang:[],sessions:[],timer:null,notificationsEnabled:false,dismissed:[],...raw};
