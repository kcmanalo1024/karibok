...
export function normalize(raw) {
 const v={name:'Student',photo:'',theme:'system',accent:'#8b3f2f',tasks:[],categories:['School','Work','Freelance','Personal'],projects:[],clients:[],payments:[],sessions:[],timer:null,notificationsEnabled:false,dismissed:[],...raw};
 for(const k of ['tasks','categories','projects','clients','payments','sessions','dismissed']) if(!Array.isArray(v[k]))v[k]=[];
